...
const ExploreByCategory = () => {
  ...
  const iconMap = {
    ...
    "Sales": <BarChart3 size={32} />,
    "Marketing": <Megaphone size={32} />,
    "Finance": <BadgeDollarSign size={32} />,
    "Management": <Monitor size={32} />,
    "Engineering": <Code2 size={32} />,
    "Business": <Briefcase size={32} />,
    "Human Resource": <Users2 size={32} />,
  };
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        {categories?.map((cat, index) => (
          <Link
            ...
            className={`group p-6 border border-gray-100 transition-all duration-300 flex flex-row md:flex-col items-center md:items-start justify-between md:justify-start gap-4 
              ${cat.name === "Marketing" 
          ...
          >
            ...
            <div className="flex-1 md:mt-4 ">
              ...
              <p className={`text-sm mt-1 font-medium ${cat.name === "Marketing" ? "text-white/80" : "text-[#7C8493] group-hover:text-white transition-all duration-300"}`}>
